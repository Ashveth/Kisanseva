  ...
  return (
    <div className="container py-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Upload or capture a leaf image to detect diseases</p>
      </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
          ...
          >
            ...
            <div className="text-center">
              <p className="font-display font-bold text-foreground">Capture or Upload Photo</p>
              <p className="text-sm text-muted-foreground mt-1">Take a photo of the affected leaf</p>
            </div>
          </button>
          <div className="glass-card p-4">
            <p className="text-xs font-display font-bold text-foreground mb-2">📌 Tips for best results:</p>
        ...
        <div className="space-y-4">
          ...
          {!result && (
            <Button
              ...
              disabled={analyzing}
              className="w-full gradient-earth text-earth-foreground font-display font-bold h-12"
            >
              {analyzing ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            <div className="glass-card p-4 border-l-4 border-l-destructive">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-display font-bold text-foreground">{result.name} Detected</h3>
                </div>
              ...
              <div className="mt-2 bg-muted/50 rounded-lg p-2 flex items-center gap-2">
                ...
                <p className="text-sm text-foreground">Confidence: <strong>{result.confidence}%</strong></p>
              </div>
            </div>
            ...
            <div className="glass-card p-4 space-y-3">
              ...
              <div className="bg-primary/5 rounded-lg p-3">
                <p className="text-xs font-medium text-primary mb-1">Chemical Treatment</p>
                <p className="text-sm text-foreground">{result.treatment}</p>
              </div>
              <div className="bg-leaf/10 rounded-lg p-3">
                <p className="text-xs font-medium text-leaf mb-1">Organic Alternative</p>
            ...
            <div className="glass-card p-4">
              <h3 className="font-display font-bold text-foreground flex items-center gap-2 mb-2">
                <Leaf className="h-4 w-4 text-primary" /> Prevention Tips
              </h3>
