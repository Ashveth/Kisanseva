...
export const translations: Record<Language, Translations> = {
  ...
  mr: {
    ...
    season: "हंगाम",
    waterNeed: "पाणी",
    selectSoilType: "तुमच्या मातीचा प्रकार निवडा",
    weatherAndLocation: "हवामान आणि स्थान",
    autoDetected: "स्वयं ओळखले",
    detectingLocation: "शोधत आहे...",
    analyzingSoil: "विश्लेषण...",
    acidic: "आम्लीय",
    neutral: "तटस्थ",
    alkaline: "अल्कधर्मी",
    soilAlluvial: "गाळाची",
  ...
  ml: {
    ...
    season: "സീസൺ",
    waterNeed: "വെള്ളം",
    selectSoilType: "നിങ്ങളുടെ മണ്ണ് തരം തിരഞ്ഞെടുക്കുക",
    weatherAndLocation: "കാലാവസ്ഥ & സ്ഥലം",
    autoDetected: "സ്വയം കണ്ടെത്തി",
    detectingLocation: "കണ്ടെത്തുന്നു...",
    analyzingSoil: "വിശകലനം...",
    acidic: "അമ്ലം",
    neutral: "നിഷ്പക്ഷം",
    alkaline: "ക്ഷാരം",
    soilAlluvial: "എക്കൽ",
  ...
  kn: {
    ...
    weatherAndLocation: "ಹವಾಮಾನ & ಸ್ಥಳ",
    autoDetected: "ಸ್ವಯಂ ಪತ್ತೆಯಾಗಿದೆ",
    detectingLocation: "ಪತ್ತೆ ಮಾಡಲಾಗುತ್ತಿದೆ...",
    analyzingSoil: "ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ...",
    acidic: "ಆಮ್ಲ",
    neutral: "ತಟಸ್ಥ",
    alkaline: "ಕ್ಷಾರ",
    soilAlluvial: "ಮೆಕ್ಕಲು",
    soilSandy: "ಮರಳು",
    soilClay: "ಜೇಡಿಮಣ್ಣು",
    soilLoamy: "ಗೋಡು",
    soilBlack: "ಕಪ್ಪು",
